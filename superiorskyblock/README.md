...
| superior.admin                 | superior.admin.count        | superior.admin.reload           | superior.admin.setsize         |
...
| superior.admin.bonus           | superior.admin.openmenu     | superior.admin.setleader        | superior.admin.withdraw        |
| superior.admin.bypass          | superior.admin.promote      | superior.admin.setmobdrops      | superior.admin.world           |
| superior.admin.chest           | superior.admin.purge        | superior.admin.setpermission    |
| superior.admin.cleargenerator  | superior.admin.rankup       | superior.admin.setrate          |
</div>
...
| %superior_island_coop_limit%               | %superior_island_locked%                      | %superior_island_visitor_last_join_&#60;name>% |
| %superior_island_count_&#60;block>%        | %superior_island_member_&#60;#>%              | %superior_island_warps%                        |
| %superior_island_creation_time%            | %superior_island_name%                        | %superior_island_warps_limit%                  |
| %superior_island_crops_multiplier%         | %superior_island_name_leader%                 | %superior_island_world%                        |
| %superior_island_discord_all%              | %superior_island_paypal%                      | %superior_island_worth%                        |
| %superior_island_discord%                  | %superior_island_nether_unlocked%             | %superior_island_worth_format%                 |
| %superior_island_drops_multiplier%         | %superior_island_paypal_all%                  | %superior_island_worth_int%                    |
| %superior_island_end_unlocked%             | %superior_island_permission_&#60;permission>% | %superior_island_worth_raw%                    |
...
|------------------------------------------------------|--------------------------------------------------------|--------------------------------------------------|
| %superior_island_location_bank%                      | %superior_island_location_is_member%                   | %superior_island_location_size%                  |
| %superior_island_location_bank_format%               | %superior_island_location_leader%                      | %superior_island_location_size_format%           |
